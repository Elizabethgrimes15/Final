...
//this.Given(/^I am on IFrame Sample Page$/, async () => {
  // await herokuappPage.goToiframeherokuapp();
//});

 //this.Then(/^I switch to IFrame Element"$/, async () => {
   // await herokuappPage.iFrameSwitch();
// });

 // this.Then(/^I see text placeholder "Your content goes here"$/, async () => {
 //  await herokuappPage.placeholderVisibilityCheck();
//});

//Login Validation
//this.Given(/^I Am on Login Validation Page$/, async () => {
 //  await seleniumEasyPage.goTologinvalidationherokuapp();
//});

 //this.Then(/^I type valid Name"$/, async () => {
   // await seleniumEasyPage.validNameInput();
 //});

 // this.Then(/^I type invalid surname$/, async () => {
   //await seleniumEasyPage.invalidPasswordInput();
//});

//this.Then(/^the Error message appears$/, async () => {
  // await seleniumEasyPage.checkValidationMessageDisplay();
//});
