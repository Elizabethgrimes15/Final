...
export class seleniumEasyRepository {
    ...
    readonly loginnameinput: ElementFinder = element(by.xpath('//*[@id="username"]'));
    readonly passwordinput: ElementFinder = element (by.xpath('//*[@id="password"]'));
    readonly invalidinputmessage: ElementFinder = element (by.xpath('//*[@id="flash"]'));
