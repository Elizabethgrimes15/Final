...
//public async goTologinvalidationherokuapp() {
  //  await browser.navigate().to(browser.params.loginvalidationherokuapp);
//}
//public async validNameInput(){
    
  //  await browser.actions().click(this.seleniumEasyRepo.loginnameinput).sendKeys('Elizaveta').perform();
//}
//public async invalidPasswordInput(){
   
  //  await browser.actions().click(this.seleniumEasyRepo.passwordinput).sendKeys('1334').perform();
//}
//public async checkValidationMessageDisplay(){
  //   await browser.wait(ExpectedConditions.visibilityOf(await this.seleniumEasyRepo.invalidinputmessage), defaultTimeout, "Timeout error");
